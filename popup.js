...
endorse.onclick = function(element) {
    chrome.tabs.query({active: true, currentWindow: true}, function(tabs) {
      chrome.tabs.executeScript(
          ...
          scrollAndThenEndorseAllTheSkills(${paramsForEndorsing.children[0].children[0].value}, "${paramsForEndorsing.children[2].children[0].value}")`
        ...
        //       left: 0,
        //     })
        //   const iterativelyScrollAndCheck = () => {
        //       if (checkIfSkillsLoaded()){
        //           scroll()
        //           document.querySelector(".pv-skills-section__additional-skills").click()
        //           setTimeout(() => endorseAllTheSkills("${paramsForEndorsing.children[0].children[0].value}", "${paramsForEndorsing.children[2].children[0].value}"), 50)
        //       }
        //       else {
        //           scroll()
        //           setTimeout(iterativelyScrollAndCheck, 50)
        //       }	
        //   }
